...
export class CreateAmcComponent implements OnInit {
  ...
  get amcProductName() { return this.amcItems.get('amcProductName'); }
  get amcProductModelNo() { return this.amcItems.get('amcProductModelNo'); }
  get amcProductSerialNo() { return this.amcItems.get('amcProductSerialNo'); }
  get amcProductWarranty() { return this.amcItems.get('amcProductWarranty'); }
  get amcProductNoService() { return this.amcItems.get('amcProductNoService'); }
  get amcProductAge() { return this.amcItems.get('amcProductAge'); }
  get amcProductValue() { return this.amcItems.get('amcProductValue'); }
  get amcProductHsn() { return this.amcItems.get('amcProductHsn'); }
  get amcProductUnit() { return this.amcItems.get('amcProductUnit'); }
  get amcProductCgstPercent() { return this.amcItems.get('amcProductCgstPercent'); }
  get amcProductSgstPercent() { return this.amcItems.get('amcProductSgstPercent'); }
  get amcProductIgstPercent() { return this.amcItems.get('amcProductIgstPercent'); }
  ...
  addAmcItems() {
    if (!this.stockEditBtn) {
      ...
      if (Number(this.amcProductCgstPercent?.value) !== 0 && Number(this.amcProductSgstPercent?.value) !== 0 && Number(this.amcProductIgstPercent?.value) === 0) {
        produtcs.push({
          productNo: 0,
          productName: String(this.amcProductName?.value),
          productModel: String(this.amcProductModelNo?.value),
          productSerialNo: String(this.amcProductSerialNo?.value),
          productAge: Number(this.amcProductAge?.value),
          productValue: Number(this.amcProductValue?.value),
          productHsn: String(this.amcProductHsn?.value),
          productQty: 1,
          productMrp: 0,
          productSalesPrice: Number(this.amcProductValue?.value),//without tax
          productPurchasePrice: Number(this.amcProductValue?.value),//without tax
          productPer: 1,
          productDiscount: 0,
          productCgstPercent: Number(this.amcProductCgstPercent?.value),
          productSgstPercent: Number(this.amcProductSgstPercent?.value),
          productIgstPercent: Number(this.amcProductIgstPercent?.value),
          productFinalGst: Number((this.amcProductCgstPercent?.value)) + Number(this.amcProductSgstPercent?.value),
          // productFinalGst: 50,
          productTotalAmount: Number(this.amcProductValue?.value),//without tax
          productNoOfService: Number(this.amcProductNoService?.value),
          productMonthOfWarranty: Number(this.amcProductWarranty?.value),
        })
      } else
        if (Number(this.amcProductCgstPercent?.value) === 0 && Number(this.amcProductSgstPercent?.value) === 0 && Number(this.amcProductIgstPercent?.value) !== 0) {
          produtcs.push({
            ...
            productSgstPercent: Number(this.amcProductSgstPercent?.value),
            productIgstPercent: Number(this.amcProductIgstPercent?.value),
            productFinalGst: Number(this.amcProductIgstPercent?.value),
            // productFinalGst: 100,
            productTotalAmount: Number(this.amcProductValue?.value),//without tax
            productNoOfService: Number(this.amcProductNoService?.value),
            productMonthOfWarranty: Number(this.amcProductWarranty?.value),
...
refresh(){
  ...
  ngOnInit(): void {
    ...
    this.amcVoucherForm = this.fb.group({
      ...
      fieldNarationx: new FormControl("hgshdgdhf")
  ...
  get transactionalAccount() {
    return this.amcVoucherForm.get('transactionalAccount');
  }

  get transactionAmount() {
    return this.amcVoucherForm.get('transactionAmount');
  }
  get fieldNaration() {
    return this.amcVoucherForm.get('fieldNaration');
  }

  get fieldTransactionDate() {
    return this.amcVoucherForm.get('fieldTransactionDate');
  }
  get fieldPartyAccount() {
    return this.amcVoucherForm.get('fieldPartyAccount');
  }
  ...
  calculateEmi() {
    ...
    if (Number(this.transactionAmount?.value) != 0 && String(this.installmentRangeNumber) != "" && Number(this.installmentRangeNumber) != null) {
      productServices = [];
      emi = [];
      ...
      for (let range: number = 0; range < Number(this.installmentRangeNumber); range++) {
        ...
        emi.push({
          ...
          emiMessage: 'Dear Customer: Your Next Emi Date On ' + String(this.datePipe.transform(emi_Date, 'yyyy-MM-dd')) + ' Rs.' + Number(this.installmentAmount),
          emiStatus: "Pending",
          emiSmsStatus: true
        })
      }
